...
#include "rotors_control/roller_controller.h"
...
void RollerController::InitializeParameters() {
...
void RollerController::CalculateRotorVelocities(Eigen::VectorXd* rotor_velocities) const {
...
void RollerController::SetOdometry(const EigenOdometry& odometry) {
  odometry_ = odometry;
}

void RollerController::SetTrajectoryPoint(
    const mav_msgs::EigenTrajectoryPoint& command_trajectory) {
  command_trajectory_ = command_trajectory;
  controller_active_ = true;
}

void RollerController::ComputeDesiredAcceleration(Eigen::Vector3d* acceleration) const {
  assert(acceleration);
...
void RollerController::ComputeDesiredAngularAcc(const Eigen::Vector3d& acceleration,
