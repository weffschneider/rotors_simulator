...
#ifndef ROTORS_CONTROL_ROLLER_CONTROLLER_H
#define ROTORS_CONTROL_ROLLER_CONTROLLER_H
...
// Default values for the roller controller and the Asctec Firefly.
...
class RollerControllerParameters {
 public:
  EIGEN_MAKE_ALIGNED_OPERATOR_NEW
  RollerControllerParameters()
...
class RollerController {
 public:
  ...
  RollerControllerParameters controller_parameters_;
...
#endif // ROTORS_CONTROL_ROLLER_CONTROLLER_H
